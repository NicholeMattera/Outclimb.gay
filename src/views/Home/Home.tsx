    ...
    return (
        <>
            ...
            <PageContent>
                ...
                >
                    <p>
                        We work with Bouldering Project Minneapolis for cost-accessible indoor climbing. We also provide
                        a space that strives to be inclusive through communal check-ins, group activities, sharing of
                        names &amp; pronouns, encouragement, and friendship.
                    </p>
                </Blurb>
            </PageContent>
        </>
